...
4.Determine the five products whose revenue declined compared with the previous year.
5.Pinpoint the most profitable sub-category.
6.List the states with the highest order volumes.
7.Identify the month with the maximum number of orders.
8.Calculate profit margin percentage per sale, i.e., Profit divided by Sales
